                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane active show fade" id="cashOnDeliveryTab" role="tabpanel" aria-labelledby="cashOnDeliveryTab-tab" tabindex="0">
                                                ...
                                                <button type="button" wire:loading.attr="disabled" wire:click="codOrder" class="btn btn-primary">
                                                    ...
                                                    <span wire:loading wire:target="codOrder">Placing Order (Cash on Delivery)</span>
                                                </button>
                                            </div>
    ...
    <script>
        paypal.Buttons({
            createOrder: function(data, actions) {
                ...
                // Proceed with creating the order if validation passes
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            value:'0.1' //$this->totalProductAmount Total Payment Amount
                        }
                    }]
                });
            },
            onApprove: function(data, actions) {
                return actions.order.capture().then(function(details) {
                    ...
                    //alert('Transaction Completed: ' + details.purchase_units[0].payments.captures[0].status);
                    // Add further order handling logic here
                });
            }
