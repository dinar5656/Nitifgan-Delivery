...
@section('title', 'Fashions Products')
  ...
  <div class="container">
    <div class="row mb-4">
      <div class="col-md-12 text-center">
        <h2 class="fw-bold">Fashions Products</h2>
    ...
    <div class="row">
      @if ($fashionsProducts && $fashionsProducts->count() > 0)
        @foreach ($fashionsProducts as $productItem)
              ...
              <div class="position-relative">
                ...
                @else
                  <img src="path/to/default-image.jpg" 
                       ...
                       alt="Default Image">
                @endif
                <span class="badge bg-danger position-absolute top-0 start-0 m-2 px-3 py-1">Fashions</span>
              </div>
              <div class="card-body">
      ...
      @else
        <div class="col-md-12 text-center">
          <div class="alert alert-warning py-5">
            <h4>No Fashions Products Available</h4>
