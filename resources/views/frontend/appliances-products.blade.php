...
@section('title', 'Appliances Products')
  ...
  <div class="container">
    <div class="row mb-4">
      <div class="col-md-12 text-center">
        <h2 class="fw-bold">Appliances Products</h2>
    ...
    <div class="row">
      @if ($appliancesProducts && $appliancesProducts->count() > 0)
        @foreach ($appliancesProducts as $productItem)
              ...
              <div class="position-relative">
                ...
                @else
                  <img src="path/to/default-image.jpg" 
                       ...
                       alt="Default Image">
                @endif
                <span class="badge bg-danger position-absolute top-0 start-0 m-2 px-3 py-1">Appliances</span>
              </div>
              <div class="card-body">
      ...
      @else
        <div class="col-md-12 text-center">
          <div class="alert alert-warning py-5">
            <h4>No Appliances Products Available</h4>
